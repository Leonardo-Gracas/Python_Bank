        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.forEach(element => {
                    content += `<div class="user" id="${element.conta}"><p id="conta">${element.conta}</p><p>${element.nome}</p><p>Saldo: R$${element.saldo.toFixed(2)}</div>`
                })
